	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'crypto-lg': '0 20px 60px -10px hsl(var(--crypto-primary) / 0.4)',
				'glow': '0 0 30px hsl(var(--crypto-glow) / 0.5)',
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%': {
						boxShadow: '0 0 20px hsl(var(--crypto-glow) / 0.3)'
					},
					'100%': {
						boxShadow: '0 0 40px hsl(var(--crypto-glow) / 0.6)'
					}
				},
				'float': {
					'0%, 100%': {
